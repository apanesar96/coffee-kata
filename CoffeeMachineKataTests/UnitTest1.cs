...
public class Tests
{
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest(Name: drink, 100, false, numberOfSugars));
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest("Tea", 40, false, 0));
        output.Should().Be("T::");
    }
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest("Tea", 50, false, 0));
        output.Should().Be("T::");
    }
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest("Chocolate", 50, false, 0));
        output.Should().Be("H::");
    }
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest("Coffee", 60, false, 0));
        output.Should().Be("C::");
    }
    ...
    {
        _coffeeMachine.Order(new DrinksOrderRequest("Orange", 100, true, 0)).Should().Be("O::");
    }

    [Test]
    public void GivenAnOrangeJuiceHasBeenSelectedWithASugar_OutputDoesNotExtraSugar()
    {
        _coffeeMachine.Order(new DrinksOrderRequest("Orange", 100, false, 1)).Should().Be("O::");
    }
    ...
    {
        var output = _coffeeMachine.Order(new DrinksOrderRequest("Tea", 30, false, 0));
